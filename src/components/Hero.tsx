  ...
  return (
    <div className='bg-auBlue h-fit p-10 max-pn:p-5'>
        ...
        <div className={`mt-20 flex justify-between items-center max-tb:flex-col max-tb:mt-10`}>
            ...
            <video src={VIDEO} width={500} height={500} autoPlay loop controls={false} muted  className='w-[680px] h-[510px] max-lt:w-[512px] max-lt:h-[384px] max-tb:w-[381.6px] max-tb:h-[286px] max-sm-pn:w-[300px] max-sm-pn:h-[225px]' />
        </div>
